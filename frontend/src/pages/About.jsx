...
function About() {
  ...
  if (path === "/about") {
    title = "เกี่ยวกับ Pattayapal";
    content = "Pattayapal คือแหล่งข่าวสารที่เชื่อถือได้ ครอบคลุมทุกมิติในพื้นที่พัทยาและบริเวณใกล้เคียง เรามุ่งมั่นที่จะนำเสนอข้อมูลที่ถูกต้อง รวดเร็ว และทันสมัย เพื่อให้คุณไม่พลาดทุกเหตุการณ์สำคัญ";
  } else if (path === "/contact") {
    title = "ติดต่อเรา";
    content = "คุณสามารถติดต่อเราได้ผ่านช่องทางโซเชียลมีเดียต่างๆ หรือส่งอีเมลมาที่ contact@pattayapal.com ทีมงานของเราพร้อมรับฟังความคิดเห็นและข้อเสนอแนะจากคุณเสมอ";
    ...
    content = "การใช้งานเว็บไซต์ Pattayapal ถือว่าคุณยอมรับเงื่อนไขและข้อตกลงในการใช้งานที่เรากำหนดไว้ โปรดใช้งานอย่างสร้างสรรค์และเคารพสิทธิของผู้อื่น";
  }
